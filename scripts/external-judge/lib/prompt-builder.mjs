 ...
 * (source noted below).
 *
 * Precondition: `claim` has {claim_id, claim_type, text, evidence}; evidence
 * is the CLAIM-SCOPED excerpt already assembled by whoever built
 * fixtures/ground-truth.json — this function does not fetch or truncate
 * from a full PRD, it only formats what it is given.
...
/**
 * @param {{claim_id: string, claim_type: string, text: string, evidence: string}} claim
 * @returns {string}
 */
