 ...
 */
import type { Degradation } from "./bound-full-state.js";
 ...
 */
export declare function boundEnvelopeResponse(payload: EnvelopePayload): BoundedEnvelope;
//# sourceMappingURL=bound-envelope-action.d.ts.map